...
static int calculateP(int ksize) {
    return ksize / 3;
}
...
nvinfer1::IElementWiseLayer* C2F(nvinfer1::INetworkDefinition* network,
    ...
    nvinfer1::ISliceLayer* split1 = network->addSlice(*conv1->getOutput(0),nvinfer1::Dims3{0,0,0},nvinfer1::Dims3{d.d[0]/2,d.d[1],d.d[2]},nvinfer1::Dims{1,1,1});
